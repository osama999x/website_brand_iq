      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10 pb-20">
        <nav aria-label="Breadcrumb" className="mb-6">
          <ol className="flex items-center gap-1.5 text-xs text-neutral-500">
            ...
            <li className="text-neutral-900 font-medium">Sustainability</li>
          </ol>
        </nav>
        ...
        <p className="text-sm text-neutral-500 mb-8">Our approach to responsible fashion.</p>

        <div className="border border-neutral-200 p-6 space-y-4 text-sm text-neutral-700">
          <p>This is a placeholder page. Add your sourcing, packaging, and manufacturing commitments here.</p>
